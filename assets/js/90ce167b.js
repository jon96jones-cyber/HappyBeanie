...
(() => {
  ...
  const stylesheet =
    ...
    // No touch-action lock here: reframe/pan gestures live on the .spill
    // layer, and blocking touch on the visible img stops page scrolling on
    // mobile wherever a finger lands on a filled slot.
